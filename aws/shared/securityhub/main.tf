...
resource "aws_securityhub_configuration_policy" "org" {
  ...
  configuration_policy {
    ...
    enabled_standard_arns = [
      "arn:aws:securityhub:${data.aws_region.admin.region}::standards/aws-foundational-security-best-practices/v/1.0.0",
      "arn:aws:securityhub:${data.aws_region.admin.region}::standards/cis-aws-foundations-benchmark/v/1.4.0",
    ]
